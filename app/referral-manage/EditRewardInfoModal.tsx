...
const EditRewardInfoModal = () => {
  const { register, watch } = useForm<TEditRewardData>();
    ...
    <dialog id="my_modal_6" className="modal w-full">
      <div className="modal-box bg-white p-10 rounded-xl">
        ...
        <form className="space-y-3">
          ...
          <div className="">
            ...
            >
              ...
              <option value="cash">Parcent</option>
            </select>
          </div>
          <div>
            <label className="font-medium text-[16px] text-heading block mb-2">
        ...
        <div className="modal-action">
          ...
          >
            <button className="w-full text-bg-primary border border-bg-primary font-medium text-[15px] rounded-xl py-3 cursor-pointer">
              Cancel
            </button>
          </form>
          <button
            onClick={handleEditReward}
            className="w-full bg-bg-primary text-white font-medium text-[15px] rounded-xl py-3 cursor-pointer"
          >
            Submit
          </button>
        </div>
